function splitReadingTestScreen() {
  ...
  // If there's already a gutter, return early to prevent reinitialization
...
// Call the function to initialize the split screen
splitReadingTestScreen();

// Initialize NiceScroll for the panels
$(document).ready(function () {
  $(".test-panel").niceScroll();
});
